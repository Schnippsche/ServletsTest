 ...
 */
public class AenderungenHolenNeu
{
   ...
   * @param conn          the conn
   */
  public AenderungenHolenNeu(String sbId, String kennung, String amt, String statistik, int aenderungsart, String typ, Connection conn)
  {
